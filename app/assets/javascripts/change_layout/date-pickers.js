...
$(document).ready(function(){
	...
	************************************/
	...
	// Default
	$( ".datepicker-default" ).datepicker({ dateFormat: 'yy-mm-dd' ,
        firstDay: 1 });

    $( ".datepicker-default1" ).datepicker({ dateFormat: 'yy-mm-dd' , firstDay: 1  });
    $( ".datepicker-default2" ).datepicker({ dateFormat: 'yy-mm-dd' , firstDay: 1  });
    $( ".datepicker-default3" ).datepicker({ dateFormat: 'yy-mm-dd' , firstDay: 1 });
